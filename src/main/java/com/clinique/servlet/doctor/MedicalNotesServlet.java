...
import com.clinique.controller.doctor.MedicalNotesController;
...
@WebServlet(name = "MedicalNotesServlet", urlPatterns = {
        "/doctor/medical-notes",
        "/doctor/medical-notes/details",
        "/doctor/medical-notes/save"
})
public class MedicalNotesServlet extends HttpServlet {

    private final MedicalNotesController controller = new MedicalNotesController();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("/doctor/medical-notes/details".equals(path)) {
            // Return medical note details as JSON
            Map<String, Object> result = controller.getMedicalNoteDetails(req);
            resp.setContentType("application/json");
            resp.setCharacterEncoding("UTF-8");
            resp.getWriter().write(JsonUtils.toJson(result));
        } else {
            // Standard page rendering
            Map<String, Object> result = controller.getMedicalNotesData(req);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("/doctor/medical-notes/save".equals(path)) {
            Map<String, Object> result = controller.saveOrUpdateMedicalNote(req);
            ...
            if ("XMLHttpRequest".equals(xRequestedWith)) {
                ...
                // Otherwise set message and redirect
